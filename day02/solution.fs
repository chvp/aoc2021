...
: part1-forward { depth pos x -- depth' pos' }
    depth pos x + ;

: part1-up { depth pos x -- depth' pos' }
    depth x negate + pos ;

: part1-down { depth pos x -- depth' pos' }
    depth x + pos ;
...
: part2-forward { aim depth pos x -- aim' depth' pos' }
    aim depth aim x * + pos x + ;

: part2-up { aim depth pos x -- aim' depth' pos' }
    aim x negate + depth pos ;

: part2-down { aim depth pos x -- aim' depth' pos' }
    aim x + depth pos ;
